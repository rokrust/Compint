...
void train_network_from_data(NeuralNetwork *network, double inputs[][2], int* data_class, double largest_value){
...
void run_network_from_data(NeuralNetwork* network, double inputs[][2], int n_inputs, double largest_value){
